    ...
    return (
        ...
        >
            {({
                ...
                const editorError =
                    touched.articleText &&
                        (errors.articleText || errors.article)
                ...
                return (
                    <Form className={css.form}>
                        ...
                        <div className={css.fields}>
                            ...
                            <div
                                className={`${css.fieldGroup} ${css.imageGroup}`}
                            >
                                
                                <div
                                    className={`${css.imageField} ${
                                        imageError ? css.fieldError : ''
                                        }`}
                                >
                                    {previewUrl ? (
                            ...
                            <div
                                className={`${css.fieldGroup} ${css.editorGroup}`}
                            >
